  ...
  return (
    ...
    >
      ...
      <nav className="px-3 py-2 space-y-0.5">
        {[
          { icon: BookOpen, label: "Academic Help" },
          { icon: HelpCircle, label: "Campus Info" },
        ].map(({ icon: Icon, label }) => (
          <button key={label} className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">
